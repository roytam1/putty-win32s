 ...
 */
#ifdef __WATCOMC__
/* OW's wtypes.h defines PROPERTYKEY, OW's propidl.h defines PROPVARIANT,
 * REFPROPVARIANT (as macro 'const PROPVARIANT *const'), and PropVariantInit.
 * Pre-set all guards so the blocks below are skipped entirely. */
