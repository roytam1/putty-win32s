...
{
    if(codepage == CP_UTF8) return Utf8ToWideChar(codepage, flags, mbstr, mblen, wcstr, wclen);
    else return MultiByteToWideChar(codepage, flags, mbstr, mblen, wcstr, wclen);
}
