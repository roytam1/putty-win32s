...
#ifdef __WATCOMC__
    /*
     * OpenWatcom miscompiles anonymous unions in designated
     * initialisers, writing the value at offset 0 of the struct
     * instead of the union's actual offset.  Use a named member.
     */
    double denominator;
#else
    union {
